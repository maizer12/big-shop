		...
		<div className='flex items-center justify-between'>
			...
			<ul className='flex gap-2'>
				{[...new Array(sumPages)].map((e, i) => (
					<li className={cn('border w-[32px] h-[32px] flex justify-center items-center cursor-pointer rounded-sm duration-500 hover:border-blue-400', { 'border-blue-400 ': value === i })} onClick={() => change(i)} key={i}>
						{i + 1}
					</li>
				))}
			</ul>
